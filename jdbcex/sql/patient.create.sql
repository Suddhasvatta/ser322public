...
-- Changed the foreign key name form REF_DOCTOR_FK to REF_DOCTOR_FK2 (as REF_DOCTOR_FK is used previously) 
		    CONSTRAINT REF_DOCTOR_FK2 FOREIGN KEY (DOCTORSSN) REFERENCES DOCTOR(SSN),
